...
public final class ServerLoginController {
    ...
    /**
     * Installs the TrueUUID gate after vanilla initializes the login profile
     * but before Forge exposes its NEGOTIATING state to the server tick.
     */
    public void afterProfileInitialized() {
        ...
        // The pending flag itself must be visible first: handleHello publishes
        // NEGOTIATING immediately after this callback, and the server tick may
        // observe that state as soon as the Netty handler advances.
