 ...
 */
/** ModLoadingContext-era configuration shared by NeoForge 20.2 and 20.4. */
public final class TrueuuidConfig {
    ...
    private static final ModConfigSpec.BooleanValue SHOW_OPERATOR_NOTIFICATIONS;
    ...
    // FML 1.x (NeoForge 20.2) still has registerConfig on ModLoadingContext;
    // modern FML moved it to ModContainer (javap-verified on FML 1.0.16 vs
    // 4.0.42+, 2026-07-16). This one line is why the module carries its own
    // copy of the otherwise-shared TrueuuidConfig.
    public static void register() { ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, SPEC); }
