...
// EventBus 6 (Forge 50/54/55). Forge 58 uses eventbus.api.listener.SubscribeEvent.
import net.minecraftforge.eventbus.api.SubscribeEvent;

/**
 * Per-version client seam: registers the account badge as a Forge HUD layer.
 * Forge 50 and Forge 54+ composite the HUD through ForgeLayeredDraw, so a raw Gui.render
