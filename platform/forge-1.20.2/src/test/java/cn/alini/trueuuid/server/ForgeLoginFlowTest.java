...
class ForgeLoginFlowTest {
    ...
    void vanillaPacketCodecWritesTheNullableEnvelopeBeforeTheTrueuuidWirePayload() {
        ...
        // 1.20.2 predates StreamCodec (1.20.5+): the packet still writes
        // itself through Packet#write(FriendlyByteBuf).
        new ServerboundCustomQueryAnswerPacket(22, new ForgeAuthAnswerPayload(answer)).write(buffer);
