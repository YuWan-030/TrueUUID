...
final class LoginFailureService {
    static GameProfile handle(GameProfile current, Connection connection, String ip, String reason,
        ...
        switch (decision.kind) {
            ...
            case OFFLINE -> TrueuuidRuntime.AUTH_STATE.markOfflineFallback(connection, AuthState.FallbackReason.FAILURE);
            case DENY -> disconnect.accept(decision.denyComponent != null ? decision.denyComponent
