...
- Added Forge build coverage for Minecraft 1.20.2, 1.21.1, 1.21.3, 1.21.4, 1.21.5, and 1.21.8.
...
- Unified every loader module on version 1.2.0 and added build/test coverage for all 20 declared targets.
...
- 新增 Minecraft 1.20.2、1.21.1、1.21.3、1.21.4、1.21.5 和 1.21.8 的 Forge 构建支持。
...
- 所有加载器模块统一使用 1.2.0 版本，并为全部 20 个已声明目标加入构建和测试覆盖。
