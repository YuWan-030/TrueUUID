...
1.21.6 / 1.21.8 / 1.21.10 (seven targets sharing `platform/forge-common`;
1.21.10 adds module-local record-era seams). Forge stops at 1.21.10 for now —
1.21.11 (Forge 61) is blocked by the FG6/Gradle-8.14 toolchain, so NeoForge
alone covers the final patch. **NeoForge
