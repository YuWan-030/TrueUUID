...
/**
 * Resolves an authlib-injector skin site's hasJoined endpoint without linking
 * authlib. The result is only a hint; the server still enforces its endpoint,
 * DNS, public-address, TLS, redirect, and response-size policies.
 */
public final class ClientYggdrasilEndpoint {
    public static String resolveHasJoinedUrl() {
        ...
        try {
            Class<?> sessionService = Class.forName(
            ...
            // No authlib-injector, inaccessible reflection, or incompatible authlib.
        }
        return "";
    }
